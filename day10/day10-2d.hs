...
atLeast3missingCount :: Int -> Int
atLeast3missingCount 0 = 0
atLeast3missingCount 1 = 0
atLeast3missingCount 2 = 0
atLeast3missingCount 3 = 1
atLeast3missingCount n = 2^(n-3)  + atLeast3missingCount (n-1)

toMultiplier :: Int -> Int
toMultiplier n = 2^body - atLeast3missingCount body
  where
    body = seqNum-2
    seqNum = n+1
